...
let itunesFeatureMapping: [iTunesVersion: String] = [.darkMode: "DJ apps and Dark Mode".localized(), .appStore: "Ringtones and iTunes U".localized(), .classicTheme: "Classic Look".localized(), .coverFlow: "CoverFlow".localized()]
